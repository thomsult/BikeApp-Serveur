...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Welcome to the BikeApp API documentation. This documentation provides information about the available endpoints, request/response formats, and authentication methods for interacting with the BikeApp API.',
    ],

    'ui' => [
        'title' => env('APP_NAME', 'BikeApp').' API Documentation',
    ],
