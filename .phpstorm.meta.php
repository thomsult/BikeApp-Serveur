...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'bikeapp.welcome_image.0.url' => 'string',
            'bikeapp.welcome_image.0.credit' => 'string',
            'bikeapp.welcome_image.0.hash' => 'string',
            'bikeapp.welcome_image.1.url' => 'string',
            'bikeapp.welcome_image.1.credit' => 'string',
            'bikeapp.welcome_image.1.hash' => 'string',
            'bikeapp.welcome_image.2.url' => 'string',
            'bikeapp.welcome_image.2.credit' => 'string',
            'bikeapp.welcome_image.2.hash' => 'string',
            'bikeapp.welcome_image.3.url' => 'string',
            'bikeapp.welcome_image.3.credit' => 'string',
            'bikeapp.welcome_image.3.hash' => 'string',
            'bikeapp.welcome_image.4.url' => 'string',
            'bikeapp.welcome_image.4.credit' => 'string',
            'bikeapp.welcome_image.4.hash' => 'string',
            ...
            'filesystems.disks.private.url' => 'string',
            'filesystems.disks.private.visibility' => 'string',
            'filesystems.disks.private.throw' => 'boolean',
            'filesystems.disks.private.report' => 'boolean',
            'filesystems.links./Users/thomsult/Dev/BikeApp-Serveur/public/storage' => 'string',
...
'__construct','viewAny','create','view','update',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.mobile_url',
...
'auth.password_timeout','bikeapp.welcome_image.0.url','bikeapp.welcome_image.0.credit','bikeapp.welcome_image.0.hash','bikeapp.welcome_image.1.url',
'bikeapp.welcome_image.1.credit','bikeapp.welcome_image.1.hash','bikeapp.welcome_image.2.url','bikeapp.welcome_image.2.credit','bikeapp.welcome_image.2.hash',
'bikeapp.welcome_image.3.url','bikeapp.welcome_image.3.credit','bikeapp.welcome_image.3.hash','bikeapp.welcome_image.4.url','bikeapp.welcome_image.4.credit',
'bikeapp.welcome_image.4.hash','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.session.driver',
...
'cache.stores.octane.driver','cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','cookie-consent.enabled',
'cookie-consent.cookie_name','cookie-consent.cookie_lifetime','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'filesystems.disks.private.driver','filesystems.disks.private.root','filesystems.disks.private.url','filesystems.disks.private.visibility','filesystems.disks.private.throw',
'filesystems.disks.private.report','filesystems.links./Users/thomsult/Dev/BikeApp-Serveur/public/storage','firebase.default','firebase.projects.app.credentials','firebase.projects.app.auth.tenant_id',
'firebase.projects.app.firestore','firebase.projects.app.database.url','firebase.projects.app.storage.default_bucket','firebase.projects.app.cache_store','firebase.projects.app.logging.http_log_channel',
'firebase.projects.app.logging.http_debug_log_channel','firebase.projects.app.http_client_options.proxy','firebase.projects.app.http_client_options.timeout','firebase.projects.app.http_client_options.guzzle_middlewares','ide-helper.filename',
...
'session.same_site','session.partitioned','scramble.api_path','scramble.api_domain','scramble.export_path',
'scramble.cache.key','scramble.cache.store','scramble.info.version','scramble.info.description','scramble.ui.title',
...
'scramble.flatten_deep_query_parameters','scramble.middleware','scramble.extensions','scramble.security_strategy','tinker.commands',
...
'profile.index','profile.store','profile.show','profile.update','profile.destroy',
'types.index','types.store','types.show','types.update','types.destroy',
'activities.index','activities.store','activities.show','activities.update','activities.destroy',
'generated::sbqdo4JFxvgucalz','generated::fHkHxfRIbNNojYrN','generated::61jIKebMwLWjr8Wk','generated::dexH6f4ZeD9uEqLo','generated::TSza4HrpUzV8UcWa',
'generated::pDc1x9aJ1fruzX85','components.index','components.store','components.show','components.update',
'components.destroy','bikes.index','bikes.store','bikes.show','bikes.update',
'bikes.destroy','generated::x4o99gduZK9n9hDT','generated::WpWZiceKT4KAcq4B','challenges.index','challenges.store',
'challenges.show','challenges.update','challenges.destroy','notifications.index','notifications.store',
'notifications.show','notifications.update','notifications.destroy','generated::WW0QGG2eqhQSML2N','generated::7ajiKHWBA1PwQ4wt',
'generated::nY8HqaAHEj0dBQcV','generated::512E68yJ7aAasr9R','success-message','lang.switch','privacy_policy',
'terms_of_service','generated::EVZJyFu7AiF9GZCw','generated::LKtT88QQuzGGlNbz','generated::014zkkamfSjapmd5','redirect_app',
'generated::STUg9inpGBeJ21w0','login','generated::zyfEvL9MeFAnBbd5','generated::UE8qY7NyNX6x4Fzd','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'components.footer','components.nav','cookie-consent::dialogContents','cookie-consent::index','index',
'mail.contact-mail','mail.test-mail','mail.welcome','privacy-policy','redirect-app',
'terms-of-service','vendor.cookie-consent.dialogContents','vendor.cookie-consent.index','vendor.mail.html.button','vendor.mail.html.footer',
...
'vendor.mail.text.message','vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','cookie-consent::dialogContents',
...
'pagination::tailwind','scramble::docs','scramble::scalar',);
...
'validation.custom.attribute-name.rule-name','bike.preferred_bike_error','bike_components.brand.Shimano','bike_components.brand.Sram','bike_components.brand.Campagnolo',
'bike_components.brand.Mavic','bike_components.brand.FSA','bike_components.brand.Fizik','bike_components.brand.Fox','bike_components.brand.Maxxis',
'bike_components.brand.Continental','bike_components.brand.Schwalbe','bike_components.brand.Specialized','bike_components.type.frame','bike_components.type.group-set',
'bike_components.type.wheel','bike_components.type.saddle','bike_components.type.fork','bike_components.type.tire','bike_components.type.handlebar',
'bike_components.type.brake','bike_components.type.chain','bike_components.type.cassette','bike_components.type.pedal','bike_components.multi_bike_change_error',
'bike_components.multi_bike_delete_error','bike_types.Road','bike_types.Mountain','bike_types.Hybrid','bike_types.Electric',
'bike_types.Gravel','bike_types.Cyclocross','bike_types.Folding','bike_types.Cargo','bike_types.Other',
'contact.success','contact.validation.name_required','contact.validation.name_string','contact.validation.name_max','contact.validation.name_min',
'contact.validation.email_required','contact.validation.email_email','contact.validation.email_max','contact.validation.subject_required','contact.validation.subject_string',
'contact.validation.subject_max','contact.validation.subject_in','contact.validation.message_required','contact.validation.message_string','contact.validation.message_max',
'index.meta.title','index.nav.Features','index.nav.Download','index.nav.About','index.nav.Support',
'index.nav.OpenApp','index.hero.title','index.hero.highlight','index.hero.subtitle','index.cards.multi-langue.title',
'index.cards.multi-langue.icon','index.cards.multi-plateforme.title','index.cards.multi-plateforme.icon','index.cards.free.title','index.cards.free.icon',
'index.features.title','index.features.description','index.features.stats.title','index.features.stats.description','index.features.maps.title',
'index.features.maps.description','index.features.badges.title','index.features.badges.description','index.features.maintenance.title','index.features.maintenance.description',
'index.features.share.title','index.features.share.description','index.features.notifications.title','index.features.notifications.description','index.download.title',
'index.download.subtitle','index.download.description','index.download.alt_text','index.download.note','index.download.workflow.step.1',
'index.download.workflow.step.2','index.download.workflow.step.3','index.about.title','index.about.description','index.contact.title',
'index.contact.location','index.contact.response_time','index.contact.description','index.contact.name','index.contact.name_placeholder',
'index.contact.email','index.contact.email_placeholder','index.contact.subject','index.contact.subject_select','index.contact.subject_bug',
'index.contact.subject_suggestion','index.contact.subject_question','index.contact.subject_other','index.contact.message','index.contact.message_placeholder',
'index.contact.send','index.footer.legal','index.footer.download','index.footer.contact','index.footer.privacy_policy',
'index.footer.terms_of_service','index.footer.tagline','index.footer.rights','index.footer.status','model.User',
'model.Activity','model.Bike','model.Components','privacy_policy.title','privacy_policy.intro',
'privacy_policy.data_collection','privacy_policy.data_collection_desc','privacy_policy.data_use','privacy_policy.data_use_desc','privacy_policy.data_sharing',
'privacy_policy.data_sharing_desc','privacy_policy.user_rights','privacy_policy.user_rights_desc','privacy_policy.contact_info','privacy_policy.contact_info_desc',
'terms_of_service.title','terms_of_service.intro','terms_of_service.user_conduct','terms_of_service.user_conduct_desc','terms_of_service.intellectual_property',
'terms_of_service.intellectual_property_desc','terms_of_service.disclaimer','terms_of_service.disclaimer_desc','terms_of_service.limitation_of_liability','terms_of_service.limitation_of_liability_desc',
'terms_of_service.governing_law','terms_of_service.governing_law_desc','validation.bike_equipment_required','validation.bike_equipment_exclusive','validation.cannot_delete_default_activity_type',
'validation.share_link.invalid','validation.token_required','validation.unauthorized','validation.not_found','auth.forget_password.user_not_found',
'auth.forget_password.link_sent','auth.forget_password.reset_successful','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ar.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ar.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.bg.texts.message',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.bg.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.bn.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.bn.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ca.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ca.texts.agree',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.cs.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.cs.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.da.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.da.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.de.texts.message',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.de.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.el.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.el.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.en.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.en.texts.agree',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.eo.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.eo.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.es.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.es.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.et.texts.message',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.et.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.fr.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.fr.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.hu.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.hu.texts.agree',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.id.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.id.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.it.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.it.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.kr.texts.message',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.kr.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.mk.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.mk.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.nb.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.nb.texts.agree',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.nl.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.nl.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.oc.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.oc.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.pl.texts.message',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.pl.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.pt.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.pt.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.pt_BR.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.pt_BR.texts.agree',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ro.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ro.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ru.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.ru.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.sk.texts.message',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.sk.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.sv.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.sv.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.th.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.th.texts.agree',
'cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.tr.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.tr.texts.agree','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.vi.texts.message','cookie-consent::.Users.thomsult.Dev.BikeApp-Serveur.vendor.spatie.laravel-cookie-consent.resources.lang.vi.texts.agree',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'DOMAIN','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'SESSION_DOMAIN','SESSION_SAME_SITE','SESSION_SECURE_COOKIE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'VITE_APP_NAME','FIREBASE_CREDENTIALS','MOBILE_URL','CLOUDFLARED_TUNNEL_TOKEN','TIMEZONE',);
